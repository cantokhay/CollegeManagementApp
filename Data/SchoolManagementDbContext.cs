...
public partial class SchoolManagementDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Classes__3214EC078903EC4B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Courses__3214EC07E02922EE");

            entity.HasIndex(e => e.Code, "UQ__Courses__A25C5AA7D037E238").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Lecturer__3214EC077392A0C4");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Students__3214EC0737BB5094");
